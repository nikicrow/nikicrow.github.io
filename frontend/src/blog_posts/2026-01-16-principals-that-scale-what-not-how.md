...
*This is Part 5 of a 6-part series on principals that scale well. Read [Part 1: Introduction](/blog/principals-that-scale-intro) first.*
...
Being very prescriptive about how something should be done is going down the route of micro management.
...
**My non-negotiables:**
- We need at least 36 months history for these 200 or so features structured in these tables
- They must be quick and reliable
...
In the end we got a great solution (the incremental merge strategy), and I learnt from how they did it!
